...
Review.create(star_rating: 4, customer_id: ginger_spice.id, restaurant_id: shack.id)
Review.create(star_rating: 5, customer_id: sporty_spice.id , restaurant_id: palace.id)
Review.create(star_rating: 3, customer_id: posh_spice.id , restaurant_id: bistro.id)
Review.create(star_rating: 2, customer_id: scary_spice.id, restaurant_id: bistro.id)
Review.create(star_rating: 5, customer_id: posh_spice.id, restaurant_id: palace.id)
